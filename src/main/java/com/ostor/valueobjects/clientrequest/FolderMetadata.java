...
import com.ostor.valueobjects.serializer.FolderMetadataDeserializer;
...
public class FolderMetadata extends Metadata {
    ...
    public static FolderMetadata deserializeFolderMetadata(JsonNode entryNode) throws IOException{
		...
		String f_sharedFolderId= GenericDeserializerUtil.getNullableText(entryNode, "shared_folder_id");
		/*FolderSharingInfo f_sharingInfo = entryNode.path("sharing_info").asText();
		List<PropertyGroup> f_propertyGroups = entryNode.path("property_groups").asLong();*/
		FolderSharingInfo f_sharingInfo = null;
		List<PropertyGroup> f_propertyGroups = null;
